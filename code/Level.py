...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        self.entity_list.extend(EntityFactory.get_entity(self.name + 'Bg'))  # creates the entities for the background
    ...
    def run(self, player_score: list[int]):
        ...
        pygame.mixer_music.play(-1)  # keeps the music playing in loops
