...
# Const T ==> related to time
SPAWN_TIME = 3500
TIMEOUT_LEVEL = 20000  # duration of each game level = 20s
TIMEOUT_STEP = 100  # step for decreasing time while playing to change level = 100 ms
