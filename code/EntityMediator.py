...
class EntityMediator:
    ...
    @staticmethod
    # this method verifies if the images (sprites) are on the screen, if not, attrib zero to the heal so it can be destroyed
    ...
    @staticmethod
    def __verify_collision_entity(ent1, ent2):  # this method verifies if the Enemies, Player and Shoots are colliding
    ...
    @staticmethod
    # calculates the score while playing
    ...
    @staticmethod
    def verify_collision(entity_list: list[Entity]):    # for entity in entity_list:
